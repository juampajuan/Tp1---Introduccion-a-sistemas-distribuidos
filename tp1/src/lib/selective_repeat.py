...
from .constants import WINDOW_SIZE, SEQUENCE_NUMBER_RANGE, PACKET_HEADER_SIZE
...
def download_selective_repeat(
    ...
    with open(dest, "wb") as f:
        while True:
            ...
            # Aceptar DATA sólo si está en la ventana (con wrap-around
            # correcto)
            if _in_window(
                    received_seq,
                    current_base,
                ...
                while current_base in buffer:
                    ...
                    current_base = _next_seq(
                        current_base, SEQUENCE_NUMBER_RANGE)
